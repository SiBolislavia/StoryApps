...
export function generateMainNavigationListTemplate() {
  return `
    ...
    <li><a id="bookmark-button" class="bookmark-button" href="#/bookmark" title="Bookmark"><i class="fas fa-bookmark"></i> Bookmark</a></li>
  `;
}
...
export function generateBookmarkItemTemplate({
  id,
  name,
  description,
  photoUrl,
  ...
  return `
    <div tabindex="0" class="story-item" data-storyid="${id}">
      ...
      <div class="story-item__body">
        ...
        <button class="btn btn-danger btn-delete-bookmark" data-id="${id}">
          Hapus Bookmark
        </button>
      </div>
    </div>
  ...
  return `
    ...
    <div class="story-detail__header">
      ...
      <div class="story-detail__body__map__container">
        ...
        <button id="bookmark-toggle-button" class="btn bookmark-toggle-button" title="Toggle Bookmark">
